...
{ 
	...
	Install_socket
	mkdir -p $pluginPath
	wget -O $pluginPath/firewalls_list.py https://raw.githubusercontent.com/cq520/bt-6.9.8-pro/master/btwaf_rule/test/btwaf/firewalls_list.py -T 5
	...
	if [ "$pyVersion" == 2 ];then
		wget -O $pluginPath/btwaf_main.zip https://raw.githubusercontent.com/cq520/bt-6.9.8-pro/master/btwaf_rule/test/btwaf/btwaf_main.zip -T 5
	...
	wget -O $pluginPath/info.json https://raw.githubusercontent.com/cq520/bt-6.9.8-pro/master/btwaf_rule/test/btwaf/info.json -T 5
