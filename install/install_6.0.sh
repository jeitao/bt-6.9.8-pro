...
if [ -f "/usr/bin/apt-get" ];then
	...
	if [ "$isDebian" != "" ];then
		wget -O install.sh https://raw.githubusercontent.com/cq520/bt-6.9.8-pro/master/install/install-ubuntu_6.0.sh && bash install.sh
		exit;
	else
		wget -O install.sh https://raw.githubusercontent.com/cq520/bt-6.9.8-pro/master/install/install-ubuntu_6.0.sh && sudo bash install.sh
		exit;
	fi
fi
...
btpanel_Url=https://raw.githubusercontent.com/cq520/bt-6.9.8-pro/master
...
curl -Ss --connect-timeout 3 -m 60 https://raw.githubusercontent.com/cq520/bt-6.9.8-pro/master/install/pip_select.sh|bash
